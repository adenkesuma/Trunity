...
export const HoverEffect = ({
  ...
  return (
    <div
      className={cn(
        "grid gris-cols-1 sm:grid-cols-2 md:grid-cols-4 py-4",
        className
      )}
    >
      {items.map((item, idx) => (
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-gray-100 border border-transparent relative z-20",
        className
      )}
    >
...
export const CardTitle = ({
  ...
  return (
    <h4 className={cn("text-blue-950 text-xl font-bold tracking-wide mt-4", className)}>
      {children}
    </h4>
  );
};
