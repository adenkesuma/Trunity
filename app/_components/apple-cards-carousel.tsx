  ...
  return (
    <CarouselContext.Provider value={{ currentIndex }}>
      <div className="relative w-full">
        <div
          className="flex w-full overflow-x-scroll overscroll-x-auto scroll-smooth pt-4 pb-2 [scrollbar-width:none]"
          ref={carouselRef}
    ...
    >
      ...
      <div className="flex flex-col md:flex-row w-full gap-2 px-6 pb-6">
        <a
          ...
          className="flex-1 flex items-center justify-center gap-1 bg-gradient-to-br from-blue-400 to-blue-800 text-white py-2 px-3 rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors"
        >
