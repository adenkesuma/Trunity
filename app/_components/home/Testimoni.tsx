...
export function Testimoni() {
  return (
    <div className="my-24">
      <h2 className="text-4xl font-semibold text-blue-950 text-center mb-6">Real Stories from our Customers</h2>
      ...
      <div className="w-full flex justify-center mt-6">
        <button className="text-white font-semibold text-sm py-2 px-4 rounded-xl bg-blue-600">Explore more</button>
      </div>
    </div>
  );
}
