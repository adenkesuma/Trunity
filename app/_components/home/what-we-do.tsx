...
import MasterDay from "@/public/assets/Frame 7.png"
import FastTrack from "@/public/assets/Frame 6.png"
import BOS from "@/public/assets/bos.jpg"
...
const VideoPopup = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 bg-opacity-75 p-4">
      <div className="relative max-w-4xl w-full max-h-[90vh] bg-transparent rounded-lg">
        {/* Tombol close */}
        <button
          onClick={onClose}
        ...
        {/* Video container */}
        <div className="relative w-full h-0 pb-[56.25%]"> {/* Default 16:9 ratio */}
          <video
            src={videoData.path}
            controls
            autoPlay
            ...
            style={{ 
              objectFit: 'contain', // Pastikan video tidak tercrop
        ...
        <div className="mt-4 text-center">
          <h3 className={`text-xl font-bold ${videoData.color}`}>
            {videoData.title}
          </h3>
        </div>
      </div>
...
export function WhatWeDo() {
  ...
  // Data video untuk setiap kegiatan
  const videoDataMap: Record<string, VideoData> = {
    fastTrack: {
      title: "Trunity Fast-Track",
      path: "/assets/fast-track.mp4",
      color: "text-white"
    },
    masterDay: {
      title: "Master Day",
    ...
    gathering: {
      title: "Gathering",
      path: "/assets/gathering-video.mp4",
      color: "text-white"
    },
    mentoring: {
      title: "Mentoring 90 Days",
      path: "/assets/mentoring.mp4",
      color: "text-white"
    }
  };

  const handleOpenVideo = (videoKey: string) => {
    setCurrentVideo(videoDataMap[videoKey]);
    setIsVideoOpen(true);
  };
    ...
    <div id="activity" className="h-full py-14 md:py-20 w-full bg-gradient-to-bl from-blue-950 to-blue-600 mt-18">
      ...
      <div className="container mx-auto my-10 px-4 sm:px-0 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col justify-between rounded-2xl bg-white shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <div className="relative">
            <Image src={BOS} alt="BOS & Gathering Events" className="h-72 object-cover rounded-2xl"/>
            {/* <video
        ...
        <div className="flex flex-col justify-between rounded-2xl bg-white shadow-lg hover:shadow-xl transition-all duration-300">
          <div className="p-6">
            ...
            <h3 className="text-xl mb-3 font-bold text-gray-900">Gathering</h3>
            <p className="text-sm text-gray-700 mb-4">Acara eksklusif untuk edukasi nasabah tentang pentingnya proteksi dan manfaat produk AXA.</p>
            <div className="mt-2">
              <span className="text-sm font-semibold text-gray-900 mb-2 block">Highlight Acara:</span>
              <div className="flex flex-wrap gap-2 mt-1">
          ...
          <div className="relative">
            ...
            <button 
              onClick={() => handleOpenVideo('gathering')}
